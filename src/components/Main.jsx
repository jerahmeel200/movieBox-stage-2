...
export default function Main() {
  ...
  useEffect(() => {
    ...
    if (searchQuery) {
      setLoading(true);
      fetch(
        `https://api.themoviedb.org/3/search/movie?api_key=0b7942e48cf9befb7703ec2fe5626b3b&language=en-US&query=${searchQuery}`
      )
        .then((res) => res.json())
        .then((data) => {
      ...
      setLoading(true);
      fetch(
        `https://api.themoviedb.org/3/movie/top_rated?api_key=0b7942e48cf9befb7703ec2fe5626b3b&language=en-US&page=1&append_to_response=images,production_countries,release_date`
      )
        .then((res) => res.json())
        .then((data) => {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/genre/movie/list?api_key=0b7942e48cf9befb7703ec2fe5626b3b&language=en-US`
    )
      .then((res) => res.json())
      .then((data) => {
      ...
      .catch((err) =>
        setError(`Error fetching genre list: ${err} Please try again later.`)
      );
  }, []);
      ...
      <section className="hero">
        <div className="heroInner">
          ...
          <div className="heroSecond">
            ...
            <p>
              John Wick is on the run after killing a member of the internatonal
                  ...
                  <div className="movieCard" data-testid="movie-card">
                    ...
                    <div className="cardStat">
                      <div className="cardStatInner">
                        ...
                        <span className="grayOut">{movie.vote_average}/10</span>
                      </div>
                      <div className="cardStatInner">
                        <img src={Tomato} alt="Rotten Tomatoes icon" />{" "}
                        <span className="grayOut">{randomTomatoRating()}%</span>
                      </div>
                    </div>
                    <p className="grayOut">
                      {movie.genre_ids
